...
class ToastCallout extends Callout {
  ToastCallout({
    ...
    super.initialCalloutPos = _initialOffsetFromGravity(gravity, width ?? Useful.scrW, height ?? 60);
  }

  Offset _initialOffsetFromGravity(Alignment alignment, double w, double h) {
    late Offset initialOffset;
    if (alignment == Alignment.topCenter) {
      initialOffset = Offset(Useful.scrW / 2 - w / 2 - 10, 10);
    } else if (alignment == Alignment.topRight) {
      initialOffset = Offset(Useful.scrW - w - 10, 10);
    } else if (alignment == Alignment.bottomCenter) {
      initialOffset = Offset(Useful.scrW / 2 - w / 2 - 10, Useful.scrH - h - 10);
    ...
    //print('initialOffset (${initialOffset.dx}, ${initialOffset.dy}), and Useful.screenW is ${Useful.screenW} and screenH is ${Useful.screenH}');
