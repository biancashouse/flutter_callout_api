...
class PathUtil {
    ...
    if (callout.arrowType == ArrowType.NO_CONNECTOR || (callout.tE == null || callout.cR().contains(Offset(callout.tE!.x, callout.tE!.y)))) {
      ...
      if (calloutR.onSameSide(pointyBase1, pointyBase2)) {
        ...
        if (distanceToNextCorner > 0 && distanceToNextCorner < callout.roundedCorners) {
          ...
          partialRectWith3CornersRounded(path, pointyBase1, pointyBase2, calloutR, callout);
          ...
          partialRectWithAll4CornersRounded(path, pointyBase1, pointyBase2, calloutR, callout);
        }
      } else {
        partialRectWith3CornersRounded(path, pointyBase1, pointyBase2, calloutR, callout);
      }
  ...
  /*
	 ...
	 */
  static void partialRectWithAll4CornersRounded(Path path, Coord pb1, Coord pb2, Rectangle theRect, callout) {
...
// path.stroke();
  ...
  static void partialRectWith3CornersRounded(Path path, Coord pb1, Coord pb2, Rectangle theRect, callout) {
