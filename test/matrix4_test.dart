...
void targetConfigTests() {
  test('target pos % offset getter and setter', () async {
    final wwName = 'widget-1';

    final capiBloc = MockCAPIBloc();

    CAPIState initialState = CAPIState(wtMap: {
      "widget-1": [
        TargetConfig(uid: 199, wwName: "widget-1")
          ..recordedM4list = [
            1.253630242823337,
            0.0,
            0.0,
    ...
    TargetConfig tc = capiBloc.state.wtMap["widget-1"]![0];
    ...
    CAPIWidgetWrapper capiWidgetWrapper = CAPIWidgetWrapper(wwName: "widget", child: Container());
