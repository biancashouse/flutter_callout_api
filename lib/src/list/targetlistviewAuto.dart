...
// import 'package:flutter_callout_api/src/wrapper/buttons/play_button_auto.dart';
...
//
//   static double targetListH(final ImageWrapperAutoState parent) => parent.bloc.state.imageTargets(parent.widget.iwName).length * 40;
//
//   @override
...
//                 ImageWrapperAutoState.hideAllTargets(bloc: parent.bloc, iwName: parent.widget.iwName);
...
//                     ImageWrapperAutoState.showAllTargets(bloc: parent.bloc, iwName: parent.widget.iwName);
//                   });
//                 });
//               },
//               children: [
...
//                   bloc: parent.bloc, iwName: parent.widget.iwName, exception: tc);
//             }
//           },
//           onDoubleTap: () {
