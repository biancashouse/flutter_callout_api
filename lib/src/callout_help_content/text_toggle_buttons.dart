...
import 'package:flutter_callout_api/src/callout_help_content/callout_alignment.dart';
import 'package:flutter_callout_api/src/callout_help_content/callout_color.dart';
import 'package:flutter_callout_api/src/callout_help_content/callout_font_family.dart';
            ...
            onPressed: (int index) {
              switch (TextToggleButton.values[index]) {
                ...
                case TextToggleButton.sizing:
                  showSizingallout(_fontSizeBtnGK, selectedTC, ancestorHScrollController, ancestorVScrollController);
                  break;
