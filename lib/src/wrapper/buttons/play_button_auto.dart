...
//     return CircleAvatar(
//       backgroundColor: parent.bloc.state.aTargetIsSelected() ? Colors.white12 : Colors.white,
//       radius: BUTTON_SIZE,
//       child: IconButton(
//         iconSize: BUTTON_SIZE,
//         icon: Icon(
//           Icons.play_arrow_sharp,
//           color: parent.bloc.state.aTargetIsSelected() ? Colors.blue.withOpacity(.2) : Colors.blue[500],
//         ),
//         onPressed: () {
//           if (parent.bloc.state.aTargetIsSelected()) return;
